...
<div class="main-content" id="mainContent">
    ...
    <form action="{{route('admin.categories.update',$category->id)}}" id="add-user-form" method="POST" enctype="multipart/form-data" class="mx-auto border rounded p-4">
        @csrf
        @method('PUT')
        <h3 class="my-4 text-center">Edit Category</h3>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-12 col-lg-10">
                <input type="text" class="form-control" id="name" value="{{!empty($category->name)?$category->name:''}}" name="name" required>
            </div>
            @if($errors->has('name'))
